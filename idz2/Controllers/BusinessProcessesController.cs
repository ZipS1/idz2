...
namespace idz2.Controllers
{
    public class BusinessProcessesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.BusinessProcesses.Include(b => b.NextProcess);
        ...
        {
            ViewData["NextProcessId"] = new SelectList(_context.BusinessProcesses, "ProcessId", "ProcessId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ProcessId,NextProcessId,ProcessName,ProcessDescription,OtherDetails")] BusinessProcesses businessProcesses)
        {
            ...
            ViewData["NextProcessId"] = new SelectList(_context.BusinessProcesses, "ProcessId", "ProcessId", businessProcesses.NextProcessId);
            return View(businessProcesses);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProcessId,NextProcessId,ProcessName,ProcessDescription,OtherDetails")] BusinessProcesses businessProcesses)
        {
