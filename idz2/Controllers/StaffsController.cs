...
namespace idz2.Controllers
{
    public class StaffsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StaffId,StaffDetails")] Staff staff)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StaffId,StaffDetails")] Staff staff)
        {
            if (id != staff.StaffId)
            {
                return NotFound();
