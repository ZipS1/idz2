...
namespace idz2.Data.Migrations
{
    ...
    [Migration("20240526174859_DocsAuthors2")]
    partial class DocsAuthors2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("idz2.Models.Documents", b =>
                {
                    ...
                    b.Property<string>("AuthorsAuthorName")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("idz2.Models.Documents", b =>
                {
                    b.HasOne("idz2.Models.Authors", "Authors")
                        .WithMany("Documents")
                        .HasForeignKey("AuthorsAuthorName");
